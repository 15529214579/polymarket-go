...
export WHALE_LIST_MIN_USD="${WHALE_LIST_MIN_USD:-core=750,sports=1000,watch=500,scout=500,target=500,tape=1000,flow=1000,leaderboard_push=3000,leaderboard_watch=3000,leaderboard_sports_push=1000,sports_holders_push=1000}"
