...
start() {
  ...
  args=(-mode=detect -signal_mode=whale -exit_mode=ladder -markets=20 -window=60 -fee_bp=0 -injury_enabled -injury_interval=5m -whale_enabled "-whale_wallets=0xdb27bf2ac5d428a9c63dbc914611036855a6c56e|drpufferfish|1000|https://polymarket.com/@drpufferfish,0xbddf61af533ff524d27154e589d2d7a81510c684|countryside|1500|https://polymarket.com/@countryside,0xc2e7800b5af46e6093872b177b7a5e7f0563be51|beachboy4|5000|https://polymarket.com/@beachboy4" -oddspapi_enabled -oddspapi_interval=3h -oddspapi_bookmaker=pinnacle -oddspapi_sports=soccer_epl,soccer_spain_la_liga,soccer_uefa_champs_league -updown_enabled -updown_interval=10m -updown_confidence=0.40 -updown_size=5 -updown_max_daily=40 -updown_db=db/btc.db)
