...
MAX_PER_MARKET_USD="${SMARTMONEY_PAPER_MAX_PER_MARKET_USD:-60}"
MAX_PER_EVENT_USD="${SMARTMONEY_PAPER_MAX_PER_EVENT_USD:-60}"
...
ESPORTS_HOLD="${SMARTMONEY_PAPER_ESPORTS_HOLD:-45m}"
...
LADDER_TP1_PCT="${SMARTMONEY_PAPER_LADDER_TP1_PCT:-0.30}"
LADDER_TP1_FRAC="${SMARTMONEY_PAPER_LADDER_TP1_FRAC:-0.50}"
LADDER_TP2_PCT="${SMARTMONEY_PAPER_LADDER_TP2_PCT:-9.99}"
LADDER_TRAILING_PCT="${SMARTMONEY_PAPER_LADDER_TRAILING_PCT:-0.20}"
LADDER_SL_PCT="${SMARTMONEY_PAPER_LADDER_SL_PCT:-0.35}"
LADDER_SL_CONFIRM="${SMARTMONEY_PAPER_LADDER_SL_CONFIRM:-30s}"
LADDER_MIN_HOLD_BEFORE_SL="${SMARTMONEY_PAPER_LADDER_MIN_HOLD_BEFORE_SL:-2m}"
LADDER_MAX_HOLD="${SMARTMONEY_PAPER_LADDER_MAX_HOLD:-60m}"
POLICY_VERSION="${SMARTMONEY_PAPER_POLICY_VERSION:-smartmoney-2026-08-13-risk-v6}"
...
prepare() {
  ...
  fi
  {
	...
	printf 'ladder_tp1_pct=%s\n' "$LADDER_TP1_PCT"
	printf 'ladder_tp1_frac=%s\n' "$LADDER_TP1_FRAC"
	printf 'ladder_tp2_pct=%s\n' "$LADDER_TP2_PCT"
	printf 'ladder_trailing_pct=%s\n' "$LADDER_TRAILING_PCT"
	printf 'ladder_sl_pct=%s\n' "$LADDER_SL_PCT"
	printf 'ladder_sl_confirm=%s\n' "$LADDER_SL_CONFIRM"
	printf 'ladder_min_hold_before_sl=%s\n' "$LADDER_MIN_HOLD_BEFORE_SL"
	printf 'ladder_max_hold=%s\n' "$LADDER_MAX_HOLD"
...
run_loop() {
  ...
  while :; do
	...
	export COPYTRADE_ESPORTS_HOLD="$ESPORTS_HOLD"
    ...
    "$ROOT/bin/bot" \
      ...
      -ladder_tp1_pct="$LADDER_TP1_PCT" \
      -ladder_tp1_frac="$LADDER_TP1_FRAC" \
      -ladder_tp2_pct="$LADDER_TP2_PCT" \
      -ladder_trailing_pct="$LADDER_TRAILING_PCT" \
      -ladder_sl_pct="$LADDER_SL_PCT" \
      -ladder_sl_confirm="$LADDER_SL_CONFIRM" \
      -ladder_min_hold_before_sl="$LADDER_MIN_HOLD_BEFORE_SL" \
      -ladder_fee_aware=true \
      -ladder_require_bid=true \
      -ladder_max_hold="$LADDER_MAX_HOLD" \
      -whale_enabled \
