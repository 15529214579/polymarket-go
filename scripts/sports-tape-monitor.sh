...
TAPE_WALLET_STATUSES="${SPORTS_TAPE_WALLET_STATUSES:-$ROOT/wallets.leaderboard-watch.txt,$ROOT/wallets.leaderboard-push.txt,$ROOT/wallets.strategy-push.txt,$ROOT/wallets.strategy-tape.txt,$ROOT/wallets.strategy-tape-observe.txt,$ROOT/wallets.strategy-tape-probation.txt,$ROOT/wallets.strategy-tape-candidates.txt,$ROOT/wallets.strategy-tape-edgehot.txt,$ROOT/wallets.strategy-tape-follow.txt,$ROOT/wallets.strategy-consensus.txt,$ROOT/wallets.strategy-tape-reversal.txt,$ROOT/wallets.strategy-review-noise.txt}"
