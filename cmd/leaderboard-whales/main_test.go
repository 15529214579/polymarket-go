...
func TestRenderReportExcludesReviewNoiseFromRecommendations(t *testing.T) {
	...
	scan := renderReport(scores, nil, map[string]string{addr: "review_noise"}, "scores.json", "push.txt", "review-noise.txt", 25, 70, 45, 20, 500, 1, 0, 80, 45, 100, 300, 20, "B", 80, 35, 50, 1000, 5, 1)
	report := scan.Report
