...
- Exclude wallets: `/Users/murphyma/work/polymarket-go/db/strategy_iteration/wallets.strategy-exclude.txt` (394)
- Valid strategies found: 153
...
- Wallets: 11
- Aggregate closed copy trades: 347
- Aggregate copy ROI: 124.2%
- Aggregate copy PnL: $+6448.06
...
|---|---|---:|---:|---:|---:|---:|---:|---:|---:|
| `0xbb35...b62a` | A | 24.86 | 1326 | 100% | 128.2% | $+2960.63 | 102 | 96.1% | 60.5% |
| `0xa75b...772c` | A | 23.25 | 320 | 100% | 101.7% | $+966.16 | 76 | 79.0% | 42.2% |
| `0xb2ed...4418` | A | 22.90 | 126 | 36% | 134.8% | $+606.44 | 37 | 67.6% | 58.6% |
...
| `0x44c4...09cb` | B | 27.23 | 135 | 63% | 108.6% | $+521.13 | 44 | 77.3% | 47.6% |
| `0x5b1d...3721` | B | 27.04 | 47 | 96% | 196.7% | $+236.02 | 9 | 88.9% | 41.9% |
| `0x6f16...5fe7` | B | 25.08 | 42 | 64% | 192.8% | $+231.31 | 12 | 83.3% | 33.9% |

## Active Watchlist

- Wallets: 20
- Aggregate closed copy trades: 583
- Aggregate copy ROI: 73.0%
- Aggregate copy PnL: $+4969.72
...
| `0x17fe...b0ca` | B | 100.0 | 32.9 | 560.6 | 128 | 100% | 106.9% | $+288.66 | 26 | 84.6% | $656 | existing |
...
| `0x819d...6e9c` | B | 100.0 | 30.4 | 496.6 | 26 | 33% | 125.6% | $+138.21 | 10 | 100.0% | $414 | existing |
| `0x18c2...529a` | B | 100.0 | 28.1 | 496.4 | 846 | 73% | 72.4% | $+564.48 | 60 | 88.3% | $276 | existing |
| `0x84cd...7565` | A | 100.0 | 23.5 | 475.8 | 123 | 79% | 93.9% | $+178.48 | 16 | 75.0% | $447 | existing |
| `0x092b...614e` | B | 100.0 | 26.3 | 470.1 | 144 | 97% | 89.7% | $+170.42 | 18 | 83.3% | $1056 | existing |
...
|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---|---|
| `0x17e2...d472` | B | 100.0 | 32.9 | 626.3 | 394 | 279 | 39% | 105.7% | $+633.92 | 57 | 96.5% | 126.4% | existing | open_copy_exposure,opposite_side_same_market |
| `0x3c2b...825e` | B | 100.0 | 32.6 | 519.3 | 378 | 246 | 94% | 143.4% | $+215.15 | 10 | 80.0% | 134.8% | existing,holder | open_copy_exposure,opposite_side_same_market |
| `0x272d...bc2f` | B | 100.0 | 28.7 | 429.3 | 461 | 240 | 45% | 89.0% | $+151.22 | 15 | 93.3% | 72.2% | existing | open_copy_exposure,opposite_side_same_market |
...
| `0x0931...e78e` | B | 100.0 | 25.6 | 379.8 | 125 | 71 | 68% | 71.2% | $+106.79 | 15 | 73.3% | 55.6% | existing | open_copy_exposure,opposite_side_same_market |
...
|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---|---|
| `0x4bff...fc26` | C | 100.0 | 41.2 | 215.3 | 56 | 5% | 0.0% | 0 | 338 | $2068 | existing,leaderboard_profit_30d,leaderboard_profit_7d | burst_trading,open_copy_exposure |
...
| `0x54f0...7725` | A | 100.0 | 23.9 | 221.9 | 263 | 170 | 85% | 12.5% | 50 | 11.7% | 57 | $691 | existing | opposite_side_same_market |
| `0x2fbb...7e44` | A | 100.0 | 24.8 | 216.3 | 322 | 146 | 99% | 27.9% | 46 | 27.9% | 46 | $193 | existing | opposite_side_same_market |
| `0x9ffe...86b5` | B | 100.0 | 25.2 | 215.6 | 54 | 50 | 84% | 31.1% | 14 | 32.5% | 16 | $3259 | existing | opposite_side_same_market |
| `0x682c...ef07` | B | 100.0 | 34.0 | 208.5 | 501 | 257 | 89% | 49.3% | 17 | 40.7% | 21 | $151 | existing,holder | open_copy_exposure,opposite_side_same_market |
...
| `0x7673...fa40` | B | 100.0 | 28.6 | 186.2 | 90 | 55 | 64% | 38.5% | 7 | 70.2% | 11 | $528 | existing | open_copy_exposure,opposite_side_same_market |
...
|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---|
| `0xa75b...772c` | A | 23.2 | $3000 | $3000 | 4 | 100.0% | +30.74 | +5.50 | +20.50 | +50.95 | 560.2 | opposite_side_same_market |
...
| `0xbb35...b62a` | A | 100.0 | 24.9 | 15m edge -2.84pp over 3 samples | 128.2% | 102 | existing,holder | open_copy_exposure,opposite_side_same_market |
| `0x4bff...fc26` | C | 100.0 | 41.2 | 1h edge -15.00pp over 4 samples | 0.0% | 0 | existing,leaderboard_profit_30d,leaderboard_profit_7d | burst_trading,open_copy_exposure |
...
| `0xb2ed...4418` | A | 100.0 | 22.9 | 1h edge -19.00pp over 1 samples | 134.8% | 37 | existing | open_copy_exposure,opposite_side_same_market |
| `0x119e...cb14` | B | 100.0 | 31.5 | 1h edge -36.88pp over 1 samples | 84.4% | 5 | existing | opposite_side_same_market |
| `0x18c2...529a` | B | 100.0 | 28.1 | 1h edge -52.95pp over 1 samples | 72.4% | 60 | existing | open_copy_exposure,opposite_side_same_market |
...
|---|---|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---|---|
| `0xa75b...772c` | pushed | - | A | 100.0 | 23.2 | 705.6 | 320 | 238 | 100% | 101.7% | 76 | 101.7% | 76 | existing,holder,sports_tape | opposite_side_same_market |
...
|---:|---:|---:|---:|---:|---:|---:|---:|---:|---|
| 1 | 11 | 347 | 124.2% | $+6448.06 | 84.7% | 134.8% | 101.7% | 2.62x | tier>=B bot<30 copyT>=8 copyROI>=100 copyPnL>=25 copyWin>=60 closedROI>=0 smart>=70 |
| 2 | 19 | 554 | 109.2% | $+8246.60 | 84.8% | 108.4% | 65.3% | 3.19x | tier>=B bot<30 copyT>=8 copyROI>=60 copyPnL>=25 copyWin>=60 closedROI>=5 smart>=70 |
| 3 | 20 | 565 | 108.4% | $+8354.03 | 84.6% | 105.1% | 65.3% | 3.16x | tier>=B bot<30 copyT>=8 copyROI>=60 copyPnL>=25 copyWin>=60 closedROI>=0 smart>=70 |
| 4 | 10 | 325 | 125.2% | $+6121.27 | 84.6% | 135.0% | 101.7% | 2.71x | tier>=B bot<30 copyT>=8 copyROI>=100 copyPnL>=25 copyWin>=60 closedROI>=20 smart>=70 |
| 5 | 18 | 545 | 109.4% | $+8162.86 | 85.1% | 108.5% | 65.3% | 3.14x | tier>=B bot<30 copyT>=8 copyROI>=60 copyPnL>=100 copyWin>=60 closedROI>=0 smart>=70 |
| 6 | 17 | 534 | 110.3% | $+8055.43 | 85.4% | 108.6% | 65.3% | 3.17x | tier>=B bot<30 copyT>=8 copyROI>=60 copyPnL>=100 copyWin>=60 closedROI>=5 smart>=70 |
| 7 | 10 | 338 | 122.5% | $+6212.04 | 84.6% | 131.5% | 101.7% | 2.63x | tier>=B bot<30 copyT>=10 copyROI>=100 copyPnL>=25 copyWin>=60 closedROI>=0 smart>=70 |
| 8 | 10 | 310 | 123.2% | $+5841.62 | 86.8% | 131.7% | 101.7% | 2.47x | tier>=B bot<30 copyT>=8 copyROI>=100 copyPnL>=25 copyWin>=70 closedROI>=0 smart>=70 |
| 9 | 18 | 532 | 109.2% | $+7919.81 | 84.8% | 105.1% | 65.3% | 3.28x | tier>=B bot<30 copyT>=8 copyROI>=60 copyPnL>=25 copyWin>=60 closedROI>=20 smart>=70 |
| 10 | 17 | 536 | 108.2% | $+7910.66 | 85.1% | 108.4% | 65.3% | 3.21x | tier>=B bot<30 copyT>=10 copyROI>=60 copyPnL>=25 copyWin>=60 closedROI>=5 smart>=70 |
| 11 | 17 | 536 | 108.0% | $+7926.84 | 85.1% | 108.4% | 65.3% | 3.16x | tier>=B bot<30 copyT>=10 copyROI>=60 copyPnL>=100 copyWin>=60 closedROI>=0 smart>=70 |
| 12 | 16 | 512 | 110.4% | $+7728.64 | 85.4% | 108.5% | 65.3% | 3.26x | tier>=B bot<30 copyT>=8 copyROI>=60 copyPnL>=100 copyWin>=60 closedROI>=20 smart>=70 |
