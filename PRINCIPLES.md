...
## P6. 大 TODO 完成要在群里公示（2026-04-19）

Phase / P0x 级别的 TODO 完成时，除了 DM 老板汇报细节，还要在团队群（草台班子）发一句里程碑消息。小条目不用。

**Why:** 团队群是对外的进度面板，别人不知道 = 等于没进展。老板 04-19 23:58 拍板。

**How:** commit 消息带 `milestone:` 前缀时，heartbeat 可以 pick up 到 state.json 的 milestones 字段，下一次 5号 醒来自动推送到群。（此机制待实现，写到 TODO.md P00 改进项。）
